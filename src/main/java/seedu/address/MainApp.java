...
public class MainApp extends Application {
    ...
    /**
     * Initialises the RestaurantBook.
     * @throws Exception
     */

    @Override
    public void init() throws Exception {
        logger.info("=============================[ Initializing RestaurantBook ]===========================");
        super.init();
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        ReadOnlyRestaurantBook initialData;
        try {
            ...
            initialData = restaurantBookOptional.orElseGet(SampleDataUtil::getSampleRestaurantBook);
        } catch (DataConversionException e) {
            logger.warning("Data file not in the correct format. Will be starting with an empty RestaurantBook");
            initialData = new RestaurantBook();
        } catch (IOException e) {
