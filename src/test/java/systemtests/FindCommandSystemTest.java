...
public class FindCommandSystemTest extends RestaurantBookSystemTest {
    ...
    @Test
    public void find() {
        /* Case: find multiple members in address book, command with leading spaces and trailing spaces
         * -> 2 members found
         */
        ...
        /* Case: find multiple members in address book, 2 keywords -> 2 members found */
        command = FindCommand.COMMAND_WORD + " Benson Daniel";
        ModelHelper.setFilteredList(expectedModel, BENSON, DANIEL);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple members in address book, 2 keywords in reversed order -> 2 members found */
        command = FindCommand.COMMAND_WORD + " Daniel Benson";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple members in address book, 2 keywords with 1 repeat -> 2 members found */
        command = FindCommand.COMMAND_WORD + " Daniel Benson Daniel";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple members in address book, 2 matching keywords and 1 non-matching keyword
         * -> 2 members found
         */
        ...
        /* Case: find member in address book, keyword is substring of name -> 0 members found */
        command = FindCommand.COMMAND_WORD + " Mei";
        ModelHelper.setFilteredList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find member in address book, name is substring of keyword -> 0 members found */
        command = FindCommand.COMMAND_WORD + " Meiers";
        ModelHelper.setFilteredList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find member not in address book -> 0 members found */
        command = FindCommand.COMMAND_WORD + " Mark";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find phone number of member in address book -> 0 members found */
        command = FindCommand.COMMAND_WORD + " " + DANIEL.getPhone().value;
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find email of member in address book -> 0 members found */
    ...
    private void assertCommandSuccess(String command, Model expectedModel) {
        String expectedResultMessage = String.format(
                MESSAGE_PERSONS_LISTED_OVERVIEW, expectedModel.getFilteredItemList(Member.class).size());
