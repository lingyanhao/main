...
public class StorageManagerTest {
    ...
    @Before
    public void setUp() {
        JsonRestaurantBookStorage addressBookStorage = new JsonRestaurantBookStorage(getTempFilePath("ab"));
    ...
    public void addressBookReadSave() throws Exception {
        /*
         * Note: This is an integration test that verifies the StorageManager is properly wired to the
         * {@link JsonRestaurantBookStorage} class.
         * More extensive testing of UserPref saving/reading is done in {@link JsonRestaurantBookStorageTest} class.
         */
